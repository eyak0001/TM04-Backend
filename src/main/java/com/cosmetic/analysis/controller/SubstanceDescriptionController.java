...
public class SubstanceDescriptionController {
    ...
    @Autowired
    private test mybatisTestMapper;
    ...
    @PostMapping("/testSub")
    public ApiResponse<List<SubstanceResult>> testSub() {

        // 测试 MyBatis Mapper
        List description = mybatisTestMapper.testQuery();



        // 返回 description 字段的字符串
        return new ApiResponse<>(200, description, "", 1);
    }
}